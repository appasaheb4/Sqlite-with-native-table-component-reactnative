    ...
    componentDidMount() { 
       // const db = SQLite.openDatabase(localDB.dbName, '1.0', '', 1);
        ...
        db.transaction(function (txn) {
            ...
            txn.executeSql('CREATE TABLE IF NOT EXISTS ' + localDB.tableName.tblStudent + ' (id  INTEGER PRIMARY KEY AUTOINCREMENT,date TEXT,user_id INTEGER,name TEXT,mark TEXT)', []);
